  ...
  return {
    ...
    'steps': [
      ...
      },
      {
        ...
        'commands': [
          'retry -- reg digest --username $DOCKER_USER --password $DOCKER_PASSWORD registry.drone.owncloud.com/owncloudci/php:%s' % prepublish,
        ],
      },
      {
        'name': 'clair',
        ...
        'commands': [
          'retry -- klar registry.drone.owncloud.com/owncloudci/php:%s' % prepublish,
        ],
      },
      {
        'name': 'publish',
      ...
      },
      {
        ...
        'commands': [
          'reg rm --username $DOCKER_USER --password $DOCKER_PASSWORD registry.drone.owncloud.com/owncloudci/php:%s' % prepublish,
        ],
        'when': {
          'status': [
            'success',
